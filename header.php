                            ...
                            elseif(is_single()):
                                ...
                                elseif(is_page()):
                                    ...
                                    elseif(is_archive()):
                                        ...
                                        <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/style.min.css" type="text/css" media="screen" />
                                        ...
                                        <?php endif;?>
                                                ...
                                                $(function(){
                                                    var local = 'localhost:8888/blog';
                                                    var hp = 'yasushikobayashi.info';
                                                    $('img,a').each(function(){
                                                        document.body.innerHTML = document.body.innerHTML.replace(local,hp);
                                                    });
                                                });
                                                ...
                                                $(document).ready(function () {//アニメーション
